...
const offsets = [
  new THREE.Vector3( 0,  0.3,  0), // topo
  new THREE.Vector3( 0, -0.3,  0), // baixo
  new THREE.Vector3( 0.3,  0,  0), // direita
  new THREE.Vector3(-0.3,  0,  0), // esquerda
  new THREE.Vector3( 0,  0,  0.3), // frente
  new THREE.Vector3( 0,  0, -0.3)  // trás
];
